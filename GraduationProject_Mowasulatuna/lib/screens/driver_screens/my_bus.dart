                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        SeatWidget(2, 'Mohmoud Draidi', proBook.seats[0]['location']),
                        SizedBox(width: w/1000,),
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        SeatWidget(2,'Obada Shobaki', proBook.seats[1]['location']),
                        SeatWidget(1, 'Tareq Ali', 'الصلعة'),
                        SeatWidget(1, 'Muath Khasati', 'الدوار'),
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
